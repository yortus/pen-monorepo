...
// -------------------- V:\oss\penc\test\fixture-inputs\import-graph\index.pen --------------------

{
    let rhs = 𝕊4;
    𝕊2.bindings.foo = sys.bindingLookup(rhs, 'f');
    𝕊2.bindings.bar = sys.bindingLookup(rhs, 'b');
    𝕊2.bindings.baz = sys.bindingLookup(rhs, 'baz');
}

𝕊2.bindings.start = 𝕊2.bindings.result; // alias
...
𝕊2.bindings.r2 = 𝕊2.bindings.rec; // alias
...
Object.assign(
    𝕊3.bindings.b,
    sys.string("b thing", 'abstract')
);

Object.assign(
    𝕊3.bindings.d,
    sys.string("d thing", 'abstract')
);

// -------------------- V:\oss\penc\test\fixture-inputs\import-graph\a.pen --------------------

// -------------------- V:\oss\penc\test\fixture-inputs\import-graph\b.pen --------------------

// -------------------- V:\oss\penc\test\fixture-inputs\import-graph\c.pen --------------------

// -------------------- V:\oss\penc\test\fixture-inputs\import-graph\d.pen --------------------

// -------------------- V:\oss\penc\test\fixture-inputs\import-graph\util\index.pen --------------------
...
𝕊9.bindings.util1 = 𝕊10; // alias

𝕊9.bindings.util2 = 𝕊11; // alias

// -------------------- V:\oss\penc\test\fixture-inputs\import-graph\util\util1.pen --------------------
...
// -------------------- V:\oss\penc\test\fixture-inputs\import-graph\util\util2 --------------------
