...
// -------------------- V:\oss\penc\test\fixture-inputs\compile-test.pen --------------------
...
{
    let rhs = 𝕊2.bindings.expr;
    𝕊2.bindings.foo1 = sys.bindingLookup(rhs, 'foo');
    𝕊2.bindings.bar = sys.bindingLookup(rhs, 'bar');
    𝕊2.bindings.quux = sys.bindingLookup(rhs, 'quux');
}

𝕊2.bindings.a = 𝕊2.bindings.b; // alias
...
𝕊3.bindings.a = 𝕊2.bindings.b; // alias
...
𝕊8.bindings.ref1 = 𝕊8.bindings.c1; // alias
