namespace sys {
    ...
    export function getState(): Registers {
        return {IDOC, IMEM, ODOC, INUL, ONUL};
    }


    export function setState(value: Registers): void {
        ({IDOC, IMEM, ODOC, INUL, ONUL} = value);
    }


    export function setInState(IDOCᐟ: unknown, IMEMᐟ: number): void {
        IDOC = IDOCᐟ;
        IMEM = IMEMᐟ;
    }


    export function setOutState(ODOCᐟ: unknown): void {
        ODOC = ODOCᐟ;
    }
    ...
    // TODO: doc... helper...
    export function isFullyConsumed(node: unknown, pos: number): boolean {
    ...
    // TODO: doc... helper...
    export function matchesAt(text: string, substr: string, position: number): boolean {
    ...
    // TODO: doc... helpers...
    export function NOT_A_LAMBDA(): never { throw new Error('Not a lambda'); };
    export function NOT_A_RULE(): never { throw new Error('Not a rule'); };
}
