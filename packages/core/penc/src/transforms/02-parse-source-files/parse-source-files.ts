...
import {NodeFromAst, SourceFileGraph, SourceProgram} from '../../representations';
...
export function parseSourceFiles(sourceFileGraph: SourceFileGraph): SourceProgram {
    let sourceFiles = mapMap(sourceFileGraph.sourceFiles, (sourceFile): NodeFromAst<SourceProgram, 'Module'> => {
