...
function emitIntrinsics(emit: Emitter, {ast}: Program) {
    ...
    const isIntrinsic = (e: V.Expression<V.NORMAL>): e is V.Intrinsic => e.kind === 'Intrinsic';
...
function emitExpression(emit: Emitter, name: string, expr: V.Expression<V.NORMAL>, mode: Mode) {
