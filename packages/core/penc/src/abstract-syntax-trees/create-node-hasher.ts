...
// import type {AbstractSyntaxTree, ExtractNode, Node, NodeKind} from '../abstract-syntax-trees';


// // TODO: doc... can't deal with Local* nodes... will throw if any encountered.
// export function createNodeHasher<AST extends AbstractSyntaxTree, KS extends NodeKind = AST extends AbstractSyntaxTree<infer>() {
