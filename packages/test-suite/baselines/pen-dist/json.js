...
const parse = (() => {
    ...
    const 𝕊0_Object = (arg) => {
        if (!𝕊0_Object_memo) 𝕊0_Object_memo = (() => {
            ...
            const t19 = (() => {
                const t21 = (() => {
                    const t23 = 𝕊0('Property');
                    const t24 = zeroOrMore({
                        mode: 6,
                        expression: (() => {
                            const t25 = 𝕊0('COMMA');
                            const t26 = 𝕊0('Property');
                            return function SEQ() {
                                let stateₒ = getState();
                                let out;
    ...
    const 𝕊0_Array = (arg) => {
        if (!𝕊0_Array_memo) 𝕊0_Array_memo = (() => {
            ...
            const t30 = (() => {
                const t32 = (() => {
                    const t34 = 𝕊0('Element');
                    const t35 = zeroOrMore({
                        mode: 6,
                        expression: (() => {
                            const t36 = 𝕊0('COMMA');
                            const t37 = 𝕊0('Element');
                            return function SEQ() {
                                let stateₒ = getState();
                                let out;
...
const print = (() => {
    ...
    const 𝕊0_Object = (arg) => {
        if (!𝕊0_Object_memo) 𝕊0_Object_memo = (() => {
            ...
            const t113 = (() => {
                const t115 = (() => {
                    const t117 = 𝕊0('Property');
                    const t118 = zeroOrMore({
                        mode: 7,
                        expression: (() => {
                            const t119 = 𝕊0('COMMA');
                            const t120 = 𝕊0('Property');
                            return function SEQ() {
                                let stateₒ = getState();
                                let out;
    ...
    const 𝕊0_Array = (arg) => {
        if (!𝕊0_Array_memo) 𝕊0_Array_memo = (() => {
            ...
            const t124 = (() => {
                const t126 = (() => {
                    const t128 = 𝕊0('Element');
                    const t129 = zeroOrMore({
                        mode: 7,
                        expression: (() => {
                            const t130 = 𝕊0('COMMA');
                            const t131 = 𝕊0('Element');
                            return function SEQ() {
                                let stateₒ = getState();
                                let out;
