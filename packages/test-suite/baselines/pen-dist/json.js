...
function createProgram({inForm, outForm}) {
    ...
    function 𝕊0_Property() {
        if (𝕊0_Property.memo) return 𝕊0_Property.memo;
        return 𝕊0_Property.memo = field({
            inForm,
            outForm,
    ...
    Object.assign(𝕊0.bindings.Property, 𝕊0_Property());
    ...
    function 𝕊0_Element() {
        if (𝕊0_Element.memo) return 𝕊0_Element.memo;
        return 𝕊0_Element.memo = list({
            inForm,
            outForm,
            elements: [
                𝕊0.bindings.Value,
    ...
    Object.assign(𝕊0.bindings.Element, 𝕊0_Element());
