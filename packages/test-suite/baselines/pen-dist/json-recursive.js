...
const parse = (() => {
    ...
    const 𝕊0_False = (arg) => {
        if (!𝕊0_False_memo) 𝕊0_False_memo = (() => {
            ...
            const t35 = booleanLiteral({mode: 6, value: false});
            return function SEQ() {
                let stateₒ = getState();
                let out;
    ...
    const 𝕊0_True = (arg) => {
        if (!𝕊0_True_memo) 𝕊0_True_memo = (() => {
            ...
            const t39 = booleanLiteral({mode: 6, value: true});
            return function SEQ() {
                let stateₒ = getState();
                let out;
...
const print = (() => {
    ...
    const 𝕊0_Value = (arg) => {
        if (!𝕊0_Value_memo) 𝕊0_Value_memo = (() => {
            ...
            const t120 = 𝕊0('Null');
            const t121 = 𝕊0('True');
            const t122 = 𝕊0('Object');
            const t123 = 𝕊0('Array');
            const t124 = 𝕊0('Number');
            const t125 = 𝕊0('String');
            return function SEL() {
                if (t119()) return true;
                if (t120()) return true;
                if (t121()) return true;
    ...
    const 𝕊0_False = (arg) => {
        if (!𝕊0_False_memo) 𝕊0_False_memo = (() => {
            ...
            const t127 = booleanLiteral({mode: 7, value: false});
            return function SEQ() {
                let stateₒ = getState();
                let out;
    ...
    const 𝕊0_True = (arg) => {
        if (!𝕊0_True_memo) 𝕊0_True_memo = (() => {
            ...
            const t131 = booleanLiteral({mode: 7, value: true});
            return function SEQ() {
                let stateₒ = getState();
                let out;
    ...
    const 𝕊0_Object = (arg) => {
        if (!𝕊0_Object_memo) 𝕊0_Object_memo = (() => {
            const t132 = 𝕊0('LBRACE');
            const t133 = (() => {
                const t135 = 𝕊0('Properties');
                const t136 = record({
                    mode: 7,
                    fields: [],
                });
    ...
    const 𝕊0_Array = (arg) => {
        if (!𝕊0_Array_memo) 𝕊0_Array_memo = (() => {
            const t143 = 𝕊0('LBRACKET');
            const t144 = (() => {
                const t146 = 𝕊0('Elements');
                const t147 = list({
                    mode: 7,
                    elements: [],
                });
