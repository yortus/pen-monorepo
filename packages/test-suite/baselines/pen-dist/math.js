...
function createProgram({inForm, outForm}) {
    ...
    // -------------------- Aliases --------------------
    𝕊0.bindings.memoise = 𝕊4.bindings.memoise;
    𝕊0.bindings.f64 = 𝕊4.bindings.f64;
    𝕊0.bindings.i32 = 𝕊4.bindings.i32;
    𝕊0.bindings.start = 𝕊0.bindings.expr;
