...
const print = (() => {
    ...
    const 𝕊0_factor = (arg) => {
        if (!𝕊0_factor_memo) 𝕊0_factor_memo = (() => {
            ...
            const t455 = (() => {
                const t465 = function STR() {
                    OUT = "0b";
                    return true;
                };
                const t466 = (𝕊0('i32'))(𝕊2);
                return function SEQ() {
                    let stateₒ = getState();
                    let out;
