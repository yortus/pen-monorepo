...
Object.assign(
    ...
    sequence({
        expressions: [
            ...
            (𝕊7.bindings.maybe).apply(sequence({
                expressions: [
                    𝕊7.bindings.COMMA,
                    𝕊7.bindings.Properties,
                ],
...
Object.assign(
    ...
    sequence({
        expressions: [
            ...
            (𝕊7.bindings.zeroOrMore).apply(𝕊7.bindings.CHAR),
            𝕊7.bindings.DOUBLE_QUOTE,
        ],
    })
);
...
Object.assign(
    ...
    selection({
        expressions: [
            sequence({
                expressions: [
                    (𝕊7.bindings.not).apply(selection({
                        expressions: [
                            character({min: "\u0000", max: "\u001f"}),
                            stringLiteral({value: "\""}),
                            stringLiteral({value: "\\"}),
...
Object.assign(
    𝕊7.bindings.WS,
    (𝕊7.bindings.zeroOrMore).apply(selection({
        expressions: [
            concrete({expr: stringLiteral({value: " "})}),
            concrete({expr: stringLiteral({value: "\t"})}),
            concrete({expr: stringLiteral({value: "\n"})}),
